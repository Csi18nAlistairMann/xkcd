...
$balloon_names = array(array('fr0001', 'fr0002'),
		       array('fr0101', 'fr0102', 'fr0103', 'fr0104', 'fr0105', 'fr0106', 'fr0107', 'fr0108', 
			     ...
			     'fr0149', 'fr0150', 'fr0151', 'fr0152', 'fr0153', 'fr0154', 'fr0155', 'fr0156',
			     'fr0157', 'fr0158', 'fr0159', 'fr0160', 'fr0161', 'fr0162', 'fr0163', 'fr0164', 
			     'fr0165', 'fr0166', 'fr0167', 'fr0168', 'fr0169', 'fr0170', 'fr0171', 'fr0172'),
...
if ($frame_array[1] > 48 && array_key_exists('ta_fr0149', $_POST)) $upload_flds_arr['fr0149'] = $_POST['ta_fr0149'];
if ($frame_array[1] > 49 && array_key_exists('ta_fr0150', $_POST)) $upload_flds_arr['fr0150'] = $_POST['ta_fr0150'];
if ($frame_array[1] > 50 && array_key_exists('ta_fr0151', $_POST)) $upload_flds_arr['fr0151'] = $_POST['ta_fr0151'];
if ($frame_array[1] > 51 && array_key_exists('ta_fr0152', $_POST)) $upload_flds_arr['fr0152'] = $_POST['ta_fr0152'];
if ($frame_array[1] > 52 && array_key_exists('ta_fr0153', $_POST)) $upload_flds_arr['fr0153'] = $_POST['ta_fr0153'];
if ($frame_array[1] > 53 && array_key_exists('ta_fr0154', $_POST)) $upload_flds_arr['fr0154'] = $_POST['ta_fr0154'];
if ($frame_array[1] > 54 && array_key_exists('ta_fr0155', $_POST)) $upload_flds_arr['fr0155'] = $_POST['ta_fr0155'];
if ($frame_array[1] > 55 && array_key_exists('ta_fr0156', $_POST)) $upload_flds_arr['fr0156'] = $_POST['ta_fr0156'];

if ($frame_array[1] > 56 && array_key_exists('ta_fr0157', $_POST)) $upload_flds_arr['fr0157'] = $_POST['ta_fr0157'];
if ($frame_array[1] > 57 && array_key_exists('ta_fr0158', $_POST)) $upload_flds_arr['fr0158'] = $_POST['ta_fr0158'];
if ($frame_array[1] > 58 && array_key_exists('ta_fr0159', $_POST)) $upload_flds_arr['fr0159'] = $_POST['ta_fr0159'];
if ($frame_array[1] > 59 && array_key_exists('ta_fr0160', $_POST)) $upload_flds_arr['fr0160'] = $_POST['ta_fr0160'];
if ($frame_array[1] > 60 && array_key_exists('ta_fr0161', $_POST)) $upload_flds_arr['fr0161'] = $_POST['ta_fr0161'];
if ($frame_array[1] > 61 && array_key_exists('ta_fr0162', $_POST)) $upload_flds_arr['fr0162'] = $_POST['ta_fr0162'];
if ($frame_array[1] > 62 && array_key_exists('ta_fr0163', $_POST)) $upload_flds_arr['fr0163'] = $_POST['ta_fr0163'];
if ($frame_array[1] > 63 && array_key_exists('ta_fr0164', $_POST)) $upload_flds_arr['fr0164'] = $_POST['ta_fr0164'];

if ($frame_array[1] > 64 && array_key_exists('ta_fr0165', $_POST)) $upload_flds_arr['fr0165'] = $_POST['ta_fr0165'];
if ($frame_array[1] > 65 && array_key_exists('ta_fr0166', $_POST)) $upload_flds_arr['fr0166'] = $_POST['ta_fr0166'];
if ($frame_array[1] > 66 && array_key_exists('ta_fr0167', $_POST)) $upload_flds_arr['fr0167'] = $_POST['ta_fr0167'];
if ($frame_array[1] > 67 && array_key_exists('ta_fr0168', $_POST)) $upload_flds_arr['fr0168'] = $_POST['ta_fr0168'];
if ($frame_array[1] > 68 && array_key_exists('ta_fr0169', $_POST)) $upload_flds_arr['fr0169'] = $_POST['ta_fr0169'];
if ($frame_array[1] > 69 && array_key_exists('ta_fr0170', $_POST)) $upload_flds_arr['fr0170'] = $_POST['ta_fr0170'];
if ($frame_array[1] > 70 && array_key_exists('ta_fr0171', $_POST)) $upload_flds_arr['fr0171'] = $_POST['ta_fr0171'];
if ($frame_array[1] > 71 && array_key_exists('ta_fr0172', $_POST)) $upload_flds_arr['fr0172'] = $_POST['ta_fr0172'];
...
if ($un !== null && $pw !== null && $lang !== null) {
  ...
  if ($allUploadFieldsPresentedF === true) {
    ...
    if ($rv !== 401 && $frame_array[1] > 48) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0149', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }
    if ($rv !== 401 && $frame_array[1] > 49) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0150', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }
    if ($rv !== 401 && $frame_array[1] > 50) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0151', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }
    if ($rv !== 401 && $frame_array[1] > 51) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0152', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }
    if ($rv !== 401 && $frame_array[1] > 52) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0153', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }
    if ($rv !== 401 && $frame_array[1] > 53) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0154', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }
    if ($rv !== 401 && $frame_array[1] > 54) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0155', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }
    if ($rv !== 401 && $frame_array[1] > 55) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0156', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }

    if ($rv !== 401 && $frame_array[1] > 56) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0157', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }
    if ($rv !== 401 && $frame_array[1] > 57) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0158', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }
    if ($rv !== 401 && $frame_array[1] > 58) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0159', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }
    if ($rv !== 401 && $frame_array[1] > 59) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0160', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }
    if ($rv !== 401 && $frame_array[1] > 60) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0161', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }
    if ($rv !== 401 && $frame_array[1] > 61) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0162', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }
    if ($rv !== 401 && $frame_array[1] > 62) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0163', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }
    if ($rv !== 401 && $frame_array[1] > 63) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0164', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }

    if ($rv !== 401 && $frame_array[1] > 64) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0165', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }
    if ($rv !== 401 && $frame_array[1] > 65) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0166', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }
    if ($rv !== 401 && $frame_array[1] > 66) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0167', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }
    if ($rv !== 401 && $frame_array[1] > 67) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0168', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }
    if ($rv !== 401 && $frame_array[1] > 68) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0169', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }
    if ($rv !== 401 && $frame_array[1] > 69) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0170', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }
    if ($rv !== 401 && $frame_array[1] > 70) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0171', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }
    if ($rv !== 401 && $frame_array[1] > 71) { $rv = post_a_new($un, $pw, $apikey, $nroot, $lang, 'anonymous', $upload_flds_arr, 'fr0172', $opt_ignore_blanks, $thisPageBelongsToSID);
      handlePOSTResponse_v2($rv, $qs_crid_arr, $uploadersid); }
...
if ($crid_array['fr0149'] !== null) echo " loadArray(crid_array, 1, 'fr0149', ${crid_array['fr0149']});\n";
if ($crid_array['fr0150'] !== null) echo " loadArray(crid_array, 1, 'fr0150', ${crid_array['fr0150']});\n";
if ($crid_array['fr0151'] !== null) echo " loadArray(crid_array, 1, 'fr0151', ${crid_array['fr0151']});\n";
if ($crid_array['fr0152'] !== null) echo " loadArray(crid_array, 1, 'fr0152', ${crid_array['fr0152']});\n";
if ($crid_array['fr0153'] !== null) echo " loadArray(crid_array, 1, 'fr0153', ${crid_array['fr0153']});\n";
if ($crid_array['fr0154'] !== null) echo " loadArray(crid_array, 1, 'fr0154', ${crid_array['fr0154']});\n";
if ($crid_array['fr0155'] !== null) echo " loadArray(crid_array, 1, 'fr0155', ${crid_array['fr0155']});\n";
if ($crid_array['fr0156'] !== null) echo " loadArray(crid_array, 1, 'fr0156', ${crid_array['fr0156']});\n";

if ($crid_array['fr0157'] !== null) echo " loadArray(crid_array, 1, 'fr0157', ${crid_array['fr0157']});\n";
if ($crid_array['fr0158'] !== null) echo " loadArray(crid_array, 1, 'fr0158', ${crid_array['fr0158']});\n";
if ($crid_array['fr0159'] !== null) echo " loadArray(crid_array, 1, 'fr0159', ${crid_array['fr0159']});\n";
if ($crid_array['fr0160'] !== null) echo " loadArray(crid_array, 1, 'fr0160', ${crid_array['fr0160']});\n";
if ($crid_array['fr0161'] !== null) echo " loadArray(crid_array, 1, 'fr0161', ${crid_array['fr0161']});\n";
if ($crid_array['fr0162'] !== null) echo " loadArray(crid_array, 1, 'fr0162', ${crid_array['fr0162']});\n";
if ($crid_array['fr0163'] !== null) echo " loadArray(crid_array, 1, 'fr0163', ${crid_array['fr0163']});\n";
if ($crid_array['fr0164'] !== null) echo " loadArray(crid_array, 1, 'fr0164', ${crid_array['fr0164']});\n";

if ($crid_array['fr0165'] !== null) echo " loadArray(crid_array, 1, 'fr0165', ${crid_array['fr0165']});\n";
if ($crid_array['fr0166'] !== null) echo " loadArray(crid_array, 1, 'fr0166', ${crid_array['fr0166']});\n";
if ($crid_array['fr0167'] !== null) echo " loadArray(crid_array, 1, 'fr0167', ${crid_array['fr0167']});\n";
if ($crid_array['fr0168'] !== null) echo " loadArray(crid_array, 1, 'fr0168', ${crid_array['fr0168']});\n";
if ($crid_array['fr0169'] !== null) echo " loadArray(crid_array, 1, 'fr0169', ${crid_array['fr0169']});\n";
if ($crid_array['fr0170'] !== null) echo " loadArray(crid_array, 1, 'fr0170', ${crid_array['fr0170']});\n";
if ($crid_array['fr0171'] !== null) echo " loadArray(crid_array, 1, 'fr0171', ${crid_array['fr0171']});\n";
if ($crid_array['fr0172'] !== null) echo " loadArray(crid_array, 1, 'fr0172', ${crid_array['fr0172']});\n";
...
include_once('common_javascript_v3a.html');
