...
$frame_array = array(2, 46, 0, 0, 0, 0, 0, 0, 0);
...
// observe only one use of name goes up as we repeat translations
if ($crid_array['fr0129'] !== null) echo " loadArray(crid_array, 1, 'fr0129', ${crid_array['fr0129']});\n";
if ($crid_array['fr0129'] !== null) echo " loadArray(crid_array, 1, 'fr0130', ${crid_array['fr0129']});\n";
if ($crid_array['fr0129'] !== null) echo " loadArray(crid_array, 1, 'fr0131', ${crid_array['fr0129']});\n";
if ($crid_array['fr0129'] !== null) echo " loadArray(crid_array, 1, 'fr0132', ${crid_array['fr0129']});\n";

if ($crid_array['fr0129'] !== null) echo " loadArray(crid_array, 1, 'fr0133', ${crid_array['fr0129']});\n";
if ($crid_array['fr0129'] !== null) echo " loadArray(crid_array, 1, 'fr0134', ${crid_array['fr0129']});\n";
if ($crid_array['fr0135'] !== null) echo " loadArray(crid_array, 1, 'fr0135', ${crid_array['fr0135']});\n";
if ($crid_array['fr0135'] !== null) echo " loadArray(crid_array, 1, 'fr0136', ${crid_array['fr0135']});\n";
if ($crid_array['fr0135'] !== null) echo " loadArray(crid_array, 1, 'fr0137', ${crid_array['fr0135']});\n";
if ($crid_array['fr0135'] !== null) echo " loadArray(crid_array, 1, 'fr0138', ${crid_array['fr0135']});\n";
if ($crid_array['fr0135'] !== null) echo " loadArray(crid_array, 1, 'fr0139', ${crid_array['fr0135']});\n";
if ($crid_array['fr0135'] !== null) echo " loadArray(crid_array, 1, 'fr0140', ${crid_array['fr0135']});\n";

if ($crid_array['fr0141'] !== null) echo " loadArray(crid_array, 1, 'fr0141', ${crid_array['fr0141']});\n";
if ($crid_array['fr0141'] !== null) echo " loadArray(crid_array, 1, 'fr0142', ${crid_array['fr0141']});\n";
if ($crid_array['fr0143'] !== null) echo " loadArray(crid_array, 1, 'fr0143', ${crid_array['fr0143']});\n";
if ($crid_array['fr0143'] !== null) echo " loadArray(crid_array, 1, 'fr0144', ${crid_array['fr0143']});\n";
if ($crid_array['fr0145'] !== null) echo " loadArray(crid_array, 1, 'fr0145', ${crid_array['fr0145']});\n";
if ($crid_array['fr0145'] !== null) echo " loadArray(crid_array, 1, 'fr0146', ${crid_array['fr0145']});\n";
