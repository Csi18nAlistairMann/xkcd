...
if ($u_username !== null && $u_password !== null && $u_languagecode !== null &&
  ...
  */
  ...
  handlePOSTResponse($rv, $crid_fr0003, $uploadersid);
  ...
  handlePOSTResponse($rv, $crid_fr0004, $uploadersid);
  ...
  handlePOSTResponse($rv, $crid_fr0005, $uploadersid);
  ...
  handlePOSTResponse($rv, $crid_fr0006, $uploadersid);
  ...
  handlePOSTResponse($rv, $crid_fr0007, $uploadersid);
  ...
  handlePOSTResponse($rv, $crid_fr0008, $uploadersid);
