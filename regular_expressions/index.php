...
if ($un !== null && $pw !== null && $lang !== null) {
  ...
  if ($allUploadFieldsPresentedF === true) {
    ...
    //-- Doc: perform POSTs
    if ($rv !== 401 && $frame_array[0] > 0) $rv = post_a_new($un, $pw, $apikey, 'xkcd-regular_expressions-fr0001', $lang, 'anonymous', $upload_flds_arr['fr0001'], $opt_ignore_blanks, $thisPageBelongsToSID);
