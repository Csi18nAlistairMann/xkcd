...
$frame_array = array(2, 0, 1, 1, 1, 3, 0, 0, 0);
...
// only one use of names goes up when we repeat translations
if ($crid_array['fr0502'] !== null) echo " loadArray(crid_array, 5, 'fr0502', ${crid_array['fr0502']});\n";
if ($crid_array['fr0502'] !== null) echo " loadArray(crid_array, 5, 'fr0503', ${crid_array['fr0502']});\n";
